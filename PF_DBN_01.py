...
all_list=["DFLIGHTNO","DIATACD","ALTEXECDATE","ONGEAR","REGEAR","DROPOFFSTART","DROPOFFEND",
          ...
          "CLEANEND","CLOSECABINGATE","CLOSECARGOGATE","PERMITPUSH","TRACTORARR",
...
#牵引车到位、    清水开始、          清水结束                     开始卸机         卸机完成
# TRACTORARR  ADDCLEARWATERSTART   ADDCLEARWATEREND          DROPOFFSTART      DROPOFFEND
# 允许放行、       实际起飞              计划起飞
